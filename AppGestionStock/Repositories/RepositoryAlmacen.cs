...
namespace AppGestionStock.Repositories
{
    public class RepositoryAlmacen : IRepositoyAlmacen
    {
        ...
        List<Cliente> IRepositoyAlmacen.GetClientes()
        {
            throw new NotImplementedException();
        }

        Cliente IRepositoyAlmacen.FindCliente(int id)
        {
            throw new NotImplementedException();
        }

        void IRepositoyAlmacen.CreateCliente(Cliente cliente)
        {
            throw new NotImplementedException();
        }

        void IRepositoyAlmacen.UpdateCliente(Cliente cliente)
        {
            throw new NotImplementedException();
        }

        void IRepositoyAlmacen.DeleteCliente(int id)
        {
            throw new NotImplementedException();
        }

        List<Proveedor> IRepositoyAlmacen.GetProveedores()
        {
            throw new NotImplementedException();
        }

        Proveedor IRepositoyAlmacen.FindProveedor(int id)
        {
            throw new NotImplementedException();
        }

        void IRepositoyAlmacen.CreateProveedor(Proveedor proveedor)
        {
            throw new NotImplementedException();
        }

        void IRepositoyAlmacen.UpdateProveedor(Proveedor proveedor)
        {
            throw new NotImplementedException();
        }

        void IRepositoyAlmacen.DeleteProveedor(int id)
        {
            throw new NotImplementedException();
        }

        List<Producto> IRepositoyAlmacen.GetProductosProveedor(int proveedorId)
        {
            throw new NotImplementedException();
        }

        List<VistaProductoTienda> IRepositoyAlmacen.GetVistaProductosTiendaConStockBajo()
        {
            throw new NotImplementedException();
        }

        Producto IRepositoyAlmacen.FindProductoAsync(int idProducto)
        {
            throw new NotImplementedException();
        }

        void IRepositoyAlmacen.UpdateProductoAsync(int idProducto, string nombreProducto, decimal precio, decimal coste, int idCategoria, string imagen)
        {
            throw new NotImplementedException();
        }

        void IRepositoyAlmacen.EliminarProducto(int idProducto)
        {
            throw new NotImplementedException();
        }

        List<Categoria> IRepositoyAlmacen.GetCategoriasAsync()
        {
            throw new NotImplementedException();
        }

        List<VistaInventarioDetalladoVenta> IRepositoyAlmacen.GetMovimientos()
        {
            throw new NotImplementedException();
        }

        List<Notificacion> IRepositoyAlmacen.GetNotificaciones()
        {
            throw new NotImplementedException();
        }

        bool IRepositoyAlmacen.ExisteNotificacion(int idProducto, int idTienda, AlmacenesContext context)
        {
            throw new NotImplementedException();
        }

        void IRepositoyAlmacen.CrearNotificacion(Notificacion notificacion, AlmacenesContext context)
        {
            throw new NotImplementedException();
        }

        void IRepositoyAlmacen.ProcesarVenta(Venta venta, List<DetallesVenta> detalles)
        {
            throw new NotImplementedException();
        }

        void IRepositoyAlmacen.ProcesarCompra(Compra compra, List<DetallesCompra> detalles)
        {
            throw new NotImplementedException();
        }

        decimal IRepositoyAlmacen.GetIngresosMes(int mes, int year)
        {
            throw new NotImplementedException();
        }

        DetallesVenta IRepositoyAlmacen.GetDetallesVenta(int idDetallesVenta)
        {
            throw new NotImplementedException();
        }

        void IRepositoyAlmacen.DeleteNotificacion(int idNotificacion)
        {
            throw new NotImplementedException();
        }

        List<Venta> IRepositoyAlmacen.GetVentas()
        {
            throw new NotImplementedException();
        }

        List<Compra> IRepositoyAlmacen.GetCompras()
        {
            throw new NotImplementedException();
        }

        List<Usuario> IRepositoyAlmacen.GetUsuariosAsync()
        {
            throw new NotImplementedException();
        }

        List<Rol> IRepositoyAlmacen.GetRoles()
        {
            throw new NotImplementedException();
        }

        void IRepositoyAlmacen.PostUsuario(string nombre, string email, string pass, int idRole)
        {
            throw new NotImplementedException();
        }

        Usuario IRepositoyAlmacen.CompararUsuario(string nombreUsuario, string password)
        {
            throw new NotImplementedException();
        }

        Usuario IRepositoyAlmacen.findUsuario(int idUsuario)
        {
            throw new NotImplementedException();
        }
        #endregion
